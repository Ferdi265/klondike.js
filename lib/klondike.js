    ...
    return inherit(null, {
        ...
        register(engine) {
            ...
            const mousedown = (event) => {
                if (this.draggedStartTarget !== null) {
                    this.cancelDrag();
                }
            ...
            engine.canvas.dom.addEventListener("mousedown", mousedown);
            engine.canvas.dom.addEventListener("touchstart", mousedown);
            engine.canvas.dom.addEventListener("mousemove", mousemove);
            engine.canvas.dom.addEventListener("touchmove", mousemove);
            engine.canvas.dom.addEventListener("mouseup", mouseup);
            engine.canvas.dom.addEventListener("touchend", mouseup);
        },
